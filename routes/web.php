...
Route::middleware(['auth', 'user-access:student'])->prefix('student')->group(function () {
    ...
    Route::get('/dashboard', [HomeController::class, 'studentDashboard'])->name('stuednt.dashboard');
});


Route::middleware(['auth', 'user-access:tutor'])->prefix('tutor')->group(function () {

    Route::get('/dashboard', [HomeController::class, 'tutorDashboard'])->name('tutor.dashboard');
});


Route::middleware(['auth', 'user-access:administrator'])->prefix('administrator')->group(function () {

    Route::get('/dashboard', [HomeController::class, 'administratorDashboard'])->name('manager.dashboard');
